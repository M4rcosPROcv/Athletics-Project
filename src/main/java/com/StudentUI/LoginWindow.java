...
public class LoginWindow {
    ...
    public LoginWindow() {
        ...
        this.scene = new Scene(mainPanel, 280, 175);
        addComponents();
        start();
    }
    ...
    public void start() {
        String css = "stylesheets/loginWindow.css";
    ...
    public void addComponents(){
        ...
        connectButton.setOnAction(event ->{
            ...
            try {
                ...
                if(userDAO.authenticate()){ // Authentication
                    ...
                    SceneController.getInstance(null).switchTo("studentUI"); // Move to main window
                }
                else{
                    // Show error message
        ...
        forgotPasswordLabel.setOnMouseClicked(e -> {SceneController.getInstance(null).switchTo("forgot");});
    }
}
